...
var Config = import_koishi.Schema.intersect([
  import_koishi.Schema.object({
    xingzhigeAPIkey: import_koishi.Schema.string().role("secret").description("星之阁的音乐API的请求key<br>（默认值是作者自己的哦，如果失效了请你自己获取一个）<br>请前往 QQ群 905188643 <br>添加QQ好友 3556898686 <br>私聊发送 `/getapikey` 获得你的APIkey以填入此处 <br>目前已经用完了`用完了申请新的key也是用完了，所以你得自己申请啦`").default("up8bpg7bItrfvuCaEdG6vrU-Kr5u68LSKpbGUMHSmsM="),
