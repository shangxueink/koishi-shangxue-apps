...
exports.Config = Schema.intersect([
  ...
  Schema.object({
    ...
    markdown_button_mode_initiative: Schema.boolean().description("开启后，使用主动md消息。<br>即开启后不带messageId发送<br>适用于私域机器人频道使用。私域机器人需要使用`被动md模板、json模板`并且使用主动markdown<br>记得对应频道设置推送上限到`2147483648条推送次数`（最大值）").default(false),
