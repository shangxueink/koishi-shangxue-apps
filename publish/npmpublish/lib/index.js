...
var Config = import_koishi.Schema.intersect([
  import_koishi.Schema.object({
    unableplatform: import_koishi.Schema.array(String).role("table").default(["onebot"]).description("允许应用的平台。在下列平台之外，本插件不会生效<br>注意 本插件仅在`onebot`平台实测可用，并且`qq`平台无法使用。其他平台可用性未知。"),
