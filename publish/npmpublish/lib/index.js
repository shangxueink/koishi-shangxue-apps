...
var Config = import_koishi.Schema.intersect([
  ...
  import_koishi.Schema.object({
    ...
    fontURL: import_koishi.Schema.string().description("字体 URL (.ttf)<br>注意：需填入本地绝对路径的URL编码地址<br>默认内容 即为使用`jrys-prpr字体`的URL示例写法").default(import_node_url.default.pathToFileURL(import_node_path.default.join(__dirname, "../../jrys-prpr/font/千图马克手写体.ttf")).href)
  }).description("高级设置"),
  import_koishi.Schema.object({
