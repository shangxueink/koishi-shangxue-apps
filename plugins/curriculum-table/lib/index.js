            ...
            .action(async ({ session, options }, param) => {
                ...
                try {
                    ...
                    try {
                        ...
                        tableInfo = JSON.parse(jsonStrings[2]); // 第3个 JSON 包含学期开始日期 "startDate"
                    ...
                    // loggerinfo(tableInfo)
                    // loggerinfo(courseInfos)
                    // loggerinfo(courseDetails)

                    // 获取学期开始日期 (从 tableInfo 中)
